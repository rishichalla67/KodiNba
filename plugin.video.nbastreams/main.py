...
VIDEOS = {
    'NBA Streams': [
        {
            'name': nbaGamesList[0][0],
            'thumb': nbaGamesList[0][1],
            'video': '',
            'genre': 'NBA BASKETBALL'
        },
        {
            'name': nbaGamesList[1][0],
            'thumb': nbaGamesList[1][1],
            'video': '',
            'genre': 'NBA BASKETBALL'
        },
        {
            'name': nbaGamesList[2][0],
            'thumb': nbaGamesList[2][1],
            'video': '',
            'genre': 'NBA BASKETBALL'
        },
        {
            'name': nbaGamesList[3][0],
            'thumb': nbaGamesList[3][1],
            'video': '',
            'genre': 'NBA BASKETBALL'
        }
    ],
    ...
    #         # testing
    #         'video': 'http://la.crackstreams.ga/show/lal/playlist.m3u8',
    #         'genre': 'Animals'
    #     },
    #     {
    #         'name': 'Turtle',
...
def play_video(path):
    ...
    # xbmc.Player().play("http://jc.crackstreams.ga/show/sas/playlist.m3u8")
